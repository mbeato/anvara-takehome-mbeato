      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="items-center md:grid md:grid-cols-2 md:gap-12">
          ...
          <div>
            ...
            >
              Connect with premium publishers and sponsors in one marketplace. Transparent pricing,
              easy management, real results.
            </motion.p>
            <motion.a
              href="/login"
          ...
          >
            <svg viewBox="0 0 420 320" className="h-auto w-full max-w-md" aria-hidden="true">
              <defs>
              ...
              >
                ...
                <polygon
                  points="282,126 296,114 310,126"
                  fill="var(--color-secondary)"
                  opacity="0.12"
                />
                {/* Text lines */}
              ...
              >
                ...
                <polygon
                  points="294,251 299,254 294,257"
                  fill="var(--color-secondary)"
                  opacity="0.3"
                />
                <rect
